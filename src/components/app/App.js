...
class App extends React.Component {
  ...
  return (
    <div  className="App"  >
      {
       heroes.map((hero) => 
       <Hero key={hero.name} name ={hero.name} alter ={hero.alter} occupation = {hero.occupation}
       friends = {hero.friends} forces = {hero.forces}  description ={hero.description}
       img = {hero.img} ></Hero> ) 
      }
